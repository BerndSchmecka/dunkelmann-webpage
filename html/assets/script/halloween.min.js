...
immediately.
***************************************************************************** */
let today=new Date;function enableHalloween(){document.querySelectorAll(".halloween").forEach(function(e){e.style.display="block"})}function disableHalloween(){document.querySelectorAll(".halloween").forEach(function(e){e.style.display="none"})}(9===today.getMonth()||10===today.getMonth()&&1===today.getDate())&&enableHalloween();